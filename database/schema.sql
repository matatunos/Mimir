...
/* Persist friendly descriptions for config keys so schema dumps include them */
SET NAMES utf8mb4;
...
-- Create config_translations table to support per-language config descriptions
...
-- Backfill Spanish translations from existing `config.description` values
